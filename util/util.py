...
def labelcolormap(N):
    if N == 35:  # cityscape
        ...
        cmap = np.array([[0,0,0],[144,238,144],[245,222,179],[211,211,211],[255,250,250],[220,220,220],[ 50, 205, 50],
                         [  255,   0, 0],[16,  78,  139],[255,250,205],[127,255,212],[ 255,255,0],[70,130, 180],[255,140,0],
                         [  0,100,  0],[250,235,215]], dtype=np.uint8)
    else:
